...
(You can Delete This!!! Comments: The LLN illustration currently uses element-wise differences (A - B), which implicitly treats the samples as paired. Since A and B are independent samples, it might be more appropriate to compare the running means of each group and then take their difference. This would better reflect the theoretical setup.)
